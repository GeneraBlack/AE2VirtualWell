...
public class ModRecipes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<WellDropRecipe>> WELL_DROP_TYPE =
            RECIPE_TYPES.register("well_drop", () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(AE2VirtualWell.MODID, "well_drop")));

    public static final DeferredHolder<RecipeSerializer<?>, WellDropRecipe.Serializer> WELL_DROP_SERIALIZER =
            SERIALIZERS.register("well_drop", WellDropRecipe.Serializer::new);
}
